        ...
        <header className="h-16 bg-white border-b border-gray-primary  mb-8">
            <div className="container mx-auto max-w-screen-lg h-full">
                <div className="flex justify-between h-full">
                    ...
                    <div className="text-gray-700 flex text-center items-center align-items  ">
                        {user ? (
                            <>
                                <Link to={ROUTES.DASHBOARD} aria-label="instaGo logo">
                                    <svg
                            ...
                            <>
                                <Link to={ROUTES.LOGIN}>
                                    <button type="button" className="bg-blue-600 font-bold text-sm rounded text-blue-medium w-20 h-8">Log In </button>
                                </Link>
